import{M as e}from"./chunk-u-ScgdE-.js";import{On as t,kn as n}from"./chunk-DCq2tb4F.js";import{t as r}from"./chunk-DGNFK8TN.js";/* empty css              */import{t as i}from"./chunk-D0_RhDi52.js";import{c as a,d as o,f as s,l as c,n as l,r as u,s as d,u as f}from"./chunk-D12Vpvjb2.js";import{t as p}from"./chunk-uhoFW7QK2.js";var m=e(r(),1),h=n();u.register(l,a,c,d,o,s,f,p);var g=.8,_=e=>e-.5*g*e*e,v=e=>{let t=e<0?-1:1;e=Math.abs(e)/Math.sqrt(2);let n=1/(1+.3275911*e);return .5*(1+t*(1-((((1.061405429*n+-1.453152027)*n+1.421413741)*n+-.284496736)*n+.254829592)*n*Math.exp(-e*e)))},y=()=>{let e=0,t=0;for(;e===0;)e=Math.random();for(;t===0;)t=Math.random();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*t)},b=()=>{let[e,n]=(0,m.useState)(.7),[r,i]=(0,m.useState)(.5),a=.52+.18*r,o=.2-.12*r,s=.2,[c,l]=(0,m.useState)(0),u=1-((e,t)=>v((.5-e)/t))(a,o),d=(1-g)/(1-u*g),{results:f}=m.useMemo(()=>{let t=()=>{let e=[a],t=a;for(let n=1;n<10;n++)t+=o*y(),t=Math.max(0,Math.min(1,t)),e.push(t);return e},n={cooperate:e=>e>.5?1-s:s,wta:e=>+(e>.5)},r=(e,t,n)=>{let r=0;for(let i=0;i<e.length;i++){let a=t(e[i]);r+=n**+i*_(a)}return r},i=Array.from({length:200},()=>t()),c={cooperate:{values:[],mean:0,std:0},wta:{values:[],mean:0,std:0}};for(let t of i)c.cooperate.values.push(r(t,n.cooperate,e)),c.wta.values.push(r(t,n.wta,e));for(let e of[`cooperate`,`wta`]){let t=c[e].values;c[e].mean=t.reduce((e,t)=>e+t,0)/t.length,c[e].std=Math.sqrt(t.reduce((t,n)=>t+(n-c[e].mean)**2,0)/t.length)}return{trajectories:i,results:c}},[a,o,10,200,s,e,c]),p=f.cooperate.mean>f.wta.mean;return(0,h.jsxs)(`div`,{className:t({margin:`2rem 0`,padding:`1.5rem`,backgroundColor:`rgba(59, 130, 246, 0.05)`,borderRadius:`4px`,border:`1px solid rgba(59, 130, 246, 0.2)`}),children:[(0,h.jsx)(`h4`,{className:t({fontSize:`1rem`,fontWeight:`medium`,textAlign:`center`,marginBottom:`1rem`,color:`#374151`}),children:`When is cooperation rational?`}),(0,h.jsxs)(`div`,{className:t({marginBottom:`1.5rem`}),children:[(0,h.jsx)(`label`,{className:t({display:`block`,fontSize:`0.85rem`,color:`#374151`,marginBottom:`0.5rem`}),children:(0,h.jsx)(`strong`,{children:`Political Security`})}),(0,h.jsxs)(`div`,{className:t({display:`flex`,justifyContent:`space-between`,fontSize:`0.75rem`,color:`#6b7280`,marginBottom:`0.25rem`}),children:[(0,h.jsx)(`span`,{children:`🐦 Ferreira (fragile)`}),(0,h.jsx)(`span`,{children:`🦉 Lindqvist (secure)`})]}),(0,h.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:r,onChange:e=>i(parseFloat(e.target.value)),className:t({width:`100%`})})]}),(0,h.jsxs)(`div`,{className:t({marginBottom:`1.5rem`}),children:[(0,h.jsx)(`label`,{className:t({display:`block`,fontSize:`0.85rem`,color:`#374151`,marginBottom:`0.5rem`}),children:(0,h.jsx)(`strong`,{children:`Patience`})}),(0,h.jsxs)(`div`,{className:t({display:`flex`,justifyContent:`space-between`,fontSize:`0.75rem`,color:`#6b7280`,marginBottom:`0.25rem`}),children:[(0,h.jsx)(`span`,{children:`Short-term`}),(0,h.jsx)(`span`,{children:`Long-term`})]}),(0,h.jsx)(`input`,{type:`range`,min:`0.1`,max:`0.99`,step:`0.01`,value:e,onChange:e=>n(parseFloat(e.target.value)),className:t({width:`100%`})})]}),(0,h.jsx)(`p`,{className:t({fontSize:`0.85rem`,color:`#374151`,textAlign:`center`,marginBottom:`0.75rem`}),children:`Expected payoff over 10 years:`}),(0,h.jsxs)(`div`,{className:t({display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`1rem`,marginBottom:`1rem`}),children:[(0,h.jsxs)(`div`,{className:t({backgroundColor:p?`#f0fdf4`:`#f9fafb`,border:p?`2px solid #22c55e`:`1px solid #e5e7eb`,borderRadius:`6px`,padding:`1rem`,textAlign:`center`}),children:[(0,h.jsxs)(`div`,{className:t({color:p?`#22c55e`:`#6b7280`,fontWeight:`bold`,fontSize:`0.9rem`}),children:[`🤝 Cooperate `,p&&`⬅`]}),(0,h.jsx)(`div`,{className:t({fontSize:`1.3rem`,fontWeight:`bold`,marginTop:`0.5rem`}),children:f.cooperate.mean.toFixed(1)})]}),(0,h.jsxs)(`div`,{className:t({backgroundColor:p?`#f9fafb`:`#fef2f2`,border:p?`1px solid #e5e7eb`:`2px solid #ef4444`,borderRadius:`6px`,padding:`1rem`,textAlign:`center`}),children:[(0,h.jsxs)(`div`,{className:t({color:p?`#6b7280`:`#ef4444`,fontWeight:`bold`,fontSize:`0.9rem`}),children:[`👊 Winner-Takes-All `,!p&&`⬅`]}),(0,h.jsx)(`div`,{className:t({fontSize:`1.3rem`,fontWeight:`bold`,marginTop:`0.5rem`}),children:f.wta.mean.toFixed(1)})]})]}),(0,h.jsx)(`p`,{className:t({fontSize:`0.9rem`,color:`#374151`,textAlign:`center`,fontStyle:`italic`,marginBottom:`1rem`}),children:(()=>{let t=r>.6?`high`:r<.4?`low`:`moderate`,n=e>.7?`high`:e<.5?`low`:`moderate`;return p?n===`high`?`With long-term thinking, cooperation pays off.`:t===`low`?`When power is fragile, sharing makes sense.`:`Cooperation is the rational choice here.`:t===`high`&&n===`low`?`With high security and low patience, refusing to compromise is rational.`:t===`high`?`Secure in power, there's no need to compromise.`:n===`low`?`With elections looming, short-term wins matter more.`:`Winner-takes-all is the rational choice here.`})()}),(0,h.jsxs)(`details`,{className:t({backgroundColor:`#f9fafb`,padding:`0.75rem`,borderRadius:`4px`,fontSize:`0.75rem`,color:`#6b7280`}),children:[(0,h.jsx)(`summary`,{className:t({cursor:`pointer`,fontWeight:`medium`}),children:`🔬 Technical details`}),(0,h.jsxs)(`div`,{className:t({marginTop:`0.5rem`}),children:[(0,h.jsx)(`strong`,{children:`Model:`}),` Random walk X_`,`{t+1}`,` = X_t + ε, ε ~ N(0, σ²)`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Parameters:`}),` X₀ = `,a.toFixed(2),`, σ = `,o.toFixed(2),`, δ = `,e.toFixed(2),(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Threshold:`}),` δ_min = `,d.toFixed(2),` (cooperation rational when δ `,`>`,` δ_min)`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Utility:`}),` U(Y) = Y − ½γY² with γ = `,g,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Simulation:`}),` `,200,` trajectories, `,10,` periods`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`button`,{onClick:()=>l(e=>e+1),className:t({marginTop:`0.5rem`,padding:`0.25rem 0.5rem`,backgroundColor:`#3b82f6`,color:`white`,border:`none`,borderRadius:`4px`,cursor:`pointer`,fontSize:`0.7rem`}),children:`🎲 Re-run simulation`})]})]})]})},x=()=>(0,h.jsxs)(`article`,{children:[(0,h.jsx)(i,{children:`
