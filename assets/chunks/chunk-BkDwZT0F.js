...
`,(0,t.jsxs)(c.p,{children:[`We will now work with a problem with data that have two-dimensional input `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`\\mathbf{x}_i = (x_{1,i}, x_{2,i})`}),` and as previously a binary label `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`y_i \\in \\{0, 1\\}`}),`. A nice example of such a data-set is a circle in a plane as visualized below.`]}),`
...
`,(0,t.jsxs)(c.li,{children:[`Apply a parametrized circuit with parameters `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`\\mathbf{w}`}),` that depend on the input `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`U(\\mathbf{w}, \\mathbf{x}_i)`}),`.`]}),`
`,(0,t.jsx)(c.li,{children:`Read out the label from the measurement of the qubit.`}),`
`]}),`
`,(0,t.jsxs)(c.p,{children:[`The main difference is now that the upload `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`S(\\mathbf{x}_i)`}),` will have multiple rotations. In our fairly simple case of two input parameters, we will then set it as:`]}),`
`,(0,t.jsx)(c.pre,{children:(0,t.jsx)(c.code,{className:`language-math math-display`,children:`\\hat{S}(x_{1,i}, x_{2,i}) = \\hat{R}_z(w_2 \\cdot x_2) \\hat{R}_x(w_1 \\cdot x_1)`})}),`
...
`,(0,t.jsxs)(c.ol,{children:[`
`,(0,t.jsxs)(c.li,{children:[`More input parameters can be handle through more gates in the layer `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`S(\\mathbf{x}_i)`})]}),`
