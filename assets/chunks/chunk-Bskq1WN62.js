...
`,(0,t.jsxs)(l.p,{children:[`The learning task is now to predict the label `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`y_i`}),` from the input value `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`x_i`}),`. To get started we have to divide the data set into a training part and a test part:`]}),`
`,(0,t.jsxs)(l.ul,{children:[`
...
`,(0,t.jsx)(l.pre,{children:(0,t.jsx)(l.code,{className:`language-math math-display`,children:`p(x) = \\frac{1}{1+e^{-(W\\cdot x+b)}}`})}),`
...
`,(0,t.jsxs)(l.li,{children:[`The value of the transition is set by the `,(0,t.jsx)(l.em,{children:`bias`}),` `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`b`}),`. For `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`x \\gg b`}),` the exponential goes to zero and `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`p(x) \\rightarrow 1`}),`, while it goes to 0 for the other side.`]}),`
`,(0,t.jsxs)(l.li,{children:[`The sharpness of the transition is set by the weight `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`W`}),`, which tells us how much of an influence we should attach to the input value `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`x`}),`.`]}),`
`]}),`
...
`,(0,t.jsxs)(l.p,{children:[`We can use this logistic regression for labelling, but simply deciding that the label is 0, if `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`p(x) <\\frac{1}{2}`}),` and and 1 if `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`p(x) > \\frac{1}{2}`}),`.`]}),`
...
`,(0,t.jsxs)(l.p,{children:[`To improve the performance of the circuit, we have to train it. This basically involves the minimization of some loss function as a function of the circuit parameters `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`W`}),` and `,(0,t.jsx)(l.code,{className:`language-math math-inline`,children:`b`}),`. In this example, we can simply calculate the accuracy of the circuit as a function of the bias and obtain its minimimum.`]}),`
