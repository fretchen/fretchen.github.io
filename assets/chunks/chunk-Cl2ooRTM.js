import{On as e}from"./chunk-DpnvOa7p.js";var t=e(),n={author:[`fretchen`],order:3,title:`QML 103 - Teaching the circle`};function r(e){let n={a:`a`,code:`code`,h2:`h2`,img:`img`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(n.p,{children:[`In the `,(0,t.jsx)(n.a,{href:`./2`,children:`last tutorial`}),` we saw how deeper algorithms allow us to model more complex dependencies of single input variables and binary labels. However, it is now time to train the algorithms on problems with more than a single input variable it is common in image recognition etc.`]}),`
`,(0,t.jsx)(n.p,{children:`In this tutorial, we will introduce slightly more complex data sets and see how we can handle the classification with data reuploading circuits. We will learn:`}),`
`,(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`that more input parameters require deeper circuits.`}),`
`,(0,t.jsx)(n.li,{children:`the required dimension of the circuit is only set by the number of labels in the problem. So in this most basic ideas of quantum machine learning algorithms.`}),`
`]}),`
...
`})}),`
`,(0,t.jsx)(n.p,{children:`And we also install the other dependencies`}),`
...
`})}),`
`,(0,t.jsx)(n.h2,{children:`Learning two-dimensional inputs`}),`
`,(0,t.jsxs)(n.p,{children:[`We will now work with a problem with data that have two-dimensional input `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`\\mathbf{x}_i = (x_{1,i}, x_{2,i})`}),` and as previously a binary label `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`y_i \\in \\{0, 1\\}`}),`. A nice example of such a data-set is a circle in a plane as visualized below.`]}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-python`,children:`def circle(samples: int, center: List[float] = [0.0, 0.0], radius:float =np.sqrt(2 / np.pi)) -> Union[np.array, np.array]:
    """
...
`})}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_5_0.png`,alt:`png`})}),`
...
f.tight_layout()
`})}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_7_0.png`,alt:`png`})}),`
`,(0,t.jsx)(n.h2,{children:`Working with multiple inputs`}),`
`,(0,t.jsxs)(n.p,{children:[`To achieve training now, we have to upload all the input parameters into the circuit. We will once again follow the `,(0,t.jsx)(n.a,{href:`https://quantum-journal.org/papers/q-2020-02-06-226/`,children:`data-reuploading approach`}),`. In summary, we will`]}),`
`,(0,t.jsxs)(n.ol,{children:[`
`,(0,t.jsx)(n.li,{children:`Prepare the initial state.`}),`
`,(0,t.jsxs)(n.li,{children:[`Apply a parametrized circuit with parameters `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`\\mathbf{w}`}),` that depend on the input `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`U(\\mathbf{w}, \\mathbf{x}_i)`}),`.`]}),`
`,(0,t.jsx)(n.li,{children:`Read out the label from the measurement of the qubit.`}),`
`]}),`
`,(0,t.jsxs)(n.p,{children:[`The main difference is now that the upload `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`S(\\mathbf{x}_i)`}),` will have multiple rotations. In our fairly simple case of two input parameters, we will then set it as:`]}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-math math-display`,children:`\\hat{S}(x_{1,i}, x_{2,i}) = \\hat{R}_z(w_2 \\cdot x_2) \\hat{R}_x(w_1 \\cdot x_1)`})}),`
...
qc.draw("mpl")
`})}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_10_0.png`,alt:`png`})}),`
...
`})}),`
`,(0,t.jsx)(n.p,{children:`The randomly initialized circuit has an accuracy of 0.3875`}),`
`,(0,t.jsx)(n.p,{children:`Now it is time to visualize the quality of the prediction with random parameters. We can clearly see that the overlap is ... random.`}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-python`,children:`f, (ax1, ax2) = plt.subplots(1, 2, figsize=(10, 5), sharex=True, sharey=True)

plot_data(x_train, y_train, fig=f, ax=ax1, title="training data")
plot_data(x_false, y_false, fig=f, ax=ax2, title="false label")
`})}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_15_0.png`,alt:`png`})}),`
`,(0,t.jsx)(n.h2,{children:`Training`}),`
`,(0,t.jsxs)(n.p,{children:[`We once again have to train the circuit as discussed in the`,(0,t.jsx)(n.a,{href:`qml102`,children:` previous tutorial`}),` with `,(0,t.jsx)(n.a,{href:`https://docs.scipy.org/doc/scipy/reference/optimize.html`,children:(0,t.jsx)(n.code,{children:`scipy.optimize`})}),` package to optimize the target function.`]}),`
...
`})}),`
`,(0,t.jsx)(n.p,{children:`accuracy = 0.53125
accuracy = 0.70625
accuracy = 0.6875
accuracy = 0.5875
accuracy = 0.5875
...
accuracy = 0.74375
accuracy = 0.7375`}),`
`,(0,t.jsx)(n.p,{children:`We can see that the accuracy is converging to a value of roughly slightly more than 70% nd it is now time to look into the optimal training parameters.`}),`
...
`})}),`
`,(0,t.jsx)(n.p,{children:`optimal weights = [1.17532389 0.86949734]
...
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-python`,children:`accuracy, y_pred = get_accuracy(qc, weights=opt_weights, alphas = opt_alphas, betas = opt_betas, gammas = opt_gammas, xvals=x_train, yvals=y_train)
...
`})}),`
`,(0,t.jsx)(n.p,{children:`The trained circuit has an accuracy of 0.73`}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-python`,children:`f, (ax1, ax2) = plt.subplots(1, 2, figsize=(10, 5), sharex=True, sharey=True)

plot_data(x_train, y_train, fig=f, ax=ax1, title="training data")
plot_data(x_false, y_false, fig=f, ax=ax2, title="false label")
`})}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_24_0.png`,alt:`png`})}),`
...
plot_data(x_false, y_false, fig=f, ax=ax2, title="false label")
`})}),`
`,(0,t.jsx)(n.p,{children:`The circuit has a test accuracy of 0.78`}),`
`,(0,t.jsx)(n.p,{children:(0,t.jsx)(n.img,{src:`./qml_103_26_1.png`,alt:`png`})}),`
`,(0,t.jsx)(n.h2,{children:`Summary and outlook`}),`
`,(0,t.jsx)(n.p,{children:`In this tutorial, we have seen that the data reuploading circuit can be extended to handle multiple input parameters. So have put everything together that we would like at this stage:`}),`
`,(0,t.jsxs)(n.ol,{children:[`
`,(0,t.jsxs)(n.li,{children:[`More input parameters can be handle through more gates in the layer `,(0,t.jsx)(n.code,{className:`language-math math-inline`,children:`S(\\mathbf{x}_i)`})]}),`
`,(0,t.jsx)(n.li,{children:`More complex data structures can be embedded through deeper circuit structures.`}),`
`]}),`
`,(0,t.jsx)(n.p,{children:`Improved circuits typically work with tuning of:`}),`
`,(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`Different optimizers.`}),`
`,(0,t.jsx)(n.li,{children:`Cost functions that are easier to differentiate.`}),`
`,(0,t.jsx)(n.li,{children:`Libraries that perform faster differentiation.`}),`
`,(0,t.jsx)(n.li,{children:`More parameters for the circuits.`}),`
`]}),`
`,(0,t.jsx)(n.p,{children:`Up to this point we have exclusively worked with circuits that work on a single qubit. While this allowed us to learn more fundamental concepts, it clearly ignores one important parameter that is commonly seen as a differentiator between classical and quantum systems, namely entanglement. So in the next and last tutorial of this series we will work with multiple qubits, entangle them and see how we can systematically study the role of entanglement in the circuit performance.`})]})}function i(e={}){let{wrapper:n}=e.components||{};return n?(0,t.jsx)(n,{...e,children:(0,t.jsx)(r,{...e})}):r(e)}export{i as default,n as frontmatter};