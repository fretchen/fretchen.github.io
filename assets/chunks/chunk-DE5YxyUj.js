import{o as e}from"./chunk-C_s2cVnS.js";import{t}from"./chunk-BcF27t_0.js";import{r as n}from"./chunk-CVYT2Lg0.js";import{t as r}from"./chunk-CRAtDASX.js";/* empty css              */import{t as i}from"./chunk-Cox02L-3.js";import{c as a,d as o,f as s,l as c,n as l,r as u,s as d,u as f}from"./chunk-C8N4HGCc.js";import{t as p}from"./chunk-CoANBhnh.js";var m=e(t(),1),h=r();u.register(l,a,c,d,o,s,f,p);var g=.8,_=e=>e-.5*g*e*e,v=e=>{let t=e<0?-1:1;e=Math.abs(e)/Math.sqrt(2);let n=1/(1+.3275911*e);return .5*(1+t*(1-((((1.061405429*n+-1.453152027)*n+1.421413741)*n+-.284496736)*n+.254829592)*n*Math.exp(-e*e)))},y=()=>{let e=0,t=0;for(;e===0;)e=Math.random();for(;t===0;)t=Math.random();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*t)},b=()=>{let[e,t]=(0,m.useState)(.7),[r,i]=(0,m.useState)(.5),a=.52+.18*r,o=.2-.12*r,s=.2,[c,l]=(0,m.useState)(0),u=.19999999999999996/(1-(1-((e,t)=>v((.5-e)/t))(a,o))*g),{results:d}=m.useMemo(()=>{let t=()=>{let e=[a],t=a;for(let n=1;n<10;n++)t+=o*y(),t=Math.max(0,Math.min(1,t)),e.push(t);return e},n={cooperate:e=>e>.5?.8:s,wta:e=>+(e>.5)},r=(e,t,n)=>{let r=0;for(let i=0;i<e.length;i++){let a=t(e[i]);r+=n**+i*_(a)}return r},i=Array.from({length:200},()=>t()),c={cooperate:{values:[],mean:0,std:0},wta:{values:[],mean:0,std:0}};for(let t of i)c.cooperate.values.push(r(t,n.cooperate,e)),c.wta.values.push(r(t,n.wta,e));for(let e of[`cooperate`,`wta`]){let t=c[e].values;c[e].mean=t.reduce((e,t)=>e+t,0)/t.length,c[e].std=Math.sqrt(t.reduce((t,n)=>t+(n-c[e].mean)**2,0)/t.length)}return{trajectories:i,results:c}},[a,o,10,200,s,e,c]),f=d.cooperate.mean>d.wta.mean;return(0,h.jsxs)(`div`,{className:n({margin:`32px 0`,padding:`6`,backgroundColor:`rgba(59, 130, 246, 0.05)`,borderRadius:`sm`,border:`1px solid rgba(59, 130, 246, 0.2)`}),children:[(0,h.jsx)(`h4`,{className:n({fontSize:`md`,fontWeight:`semibold`,textAlign:`center`,marginBottom:`4`,color:`gray.700`}),children:`When is cooperation rational?`}),(0,h.jsxs)(`div`,{className:n({marginBottom:`6`}),children:[(0,h.jsx)(`label`,{className:n({display:`block`,fontSize:`sm`,color:`gray.700`,marginBottom:`2`}),children:(0,h.jsx)(`strong`,{children:`Political Security`})}),(0,h.jsxs)(`div`,{className:n({display:`flex`,justifyContent:`space-between`,fontSize:`xs`,color:`gray.500`,marginBottom:`1`}),children:[(0,h.jsx)(`span`,{children:`🐦 Ferreira (fragile)`}),(0,h.jsx)(`span`,{children:`🦉 Lindqvist (secure)`})]}),(0,h.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:r,onChange:e=>i(parseFloat(e.target.value)),className:n({width:`100%`})})]}),(0,h.jsxs)(`div`,{className:n({marginBottom:`6`}),children:[(0,h.jsx)(`label`,{className:n({display:`block`,fontSize:`sm`,color:`gray.700`,marginBottom:`2`}),children:(0,h.jsx)(`strong`,{children:`Patience`})}),(0,h.jsxs)(`div`,{className:n({display:`flex`,justifyContent:`space-between`,fontSize:`xs`,color:`gray.500`,marginBottom:`1`}),children:[(0,h.jsx)(`span`,{children:`Short-term`}),(0,h.jsx)(`span`,{children:`Long-term`})]}),(0,h.jsx)(`input`,{type:`range`,min:`0.1`,max:`0.99`,step:`0.01`,value:e,onChange:e=>t(parseFloat(e.target.value)),className:n({width:`100%`})})]}),(0,h.jsx)(`p`,{className:n({fontSize:`sm`,color:`gray.700`,textAlign:`center`,marginBottom:`3`}),children:`Expected payoff over 10 years:`}),(0,h.jsxs)(`div`,{className:n({display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`4`,marginBottom:`4`}),children:[(0,h.jsxs)(`div`,{className:n({backgroundColor:f?`green.50`:`codeBg`,border:f?`2px solid #22c55e`:`1px solid #e5e7eb`,borderRadius:`md`,padding:`4`,textAlign:`center`}),children:[(0,h.jsxs)(`div`,{className:n({color:f?`green.500`:`gray.500`,fontWeight:`bold`,fontSize:`md`}),children:[`🤝 Cooperate `,f&&`⬅`]}),(0,h.jsx)(`div`,{className:n({fontSize:`xl`,fontWeight:`bold`,marginTop:`2`}),children:d.cooperate.mean.toFixed(1)})]}),(0,h.jsxs)(`div`,{className:n({backgroundColor:f?`codeBg`:`red.50`,border:f?`1px solid #e5e7eb`:`2px solid #ef4444`,borderRadius:`md`,padding:`4`,textAlign:`center`}),children:[(0,h.jsxs)(`div`,{className:n({color:f?`gray.500`:`red.500`,fontWeight:`bold`,fontSize:`md`}),children:[`👊 Winner-Takes-All `,!f&&`⬅`]}),(0,h.jsx)(`div`,{className:n({fontSize:`xl`,fontWeight:`bold`,marginTop:`2`}),children:d.wta.mean.toFixed(1)})]})]}),(0,h.jsx)(`p`,{className:n({fontSize:`md`,color:`gray.700`,textAlign:`center`,fontStyle:`italic`,marginBottom:`4`}),children:(()=>{let t=r>.6?`high`:r<.4?`low`:`moderate`,n=e>.7?`high`:e<.5?`low`:`moderate`;return f?n===`high`?`With long-term thinking, cooperation pays off.`:t===`low`?`When power is fragile, sharing makes sense.`:`Cooperation is the rational choice here.`:t===`high`&&n===`low`?`With high security and low patience, refusing to compromise is rational.`:t===`high`?`Secure in power, there's no need to compromise.`:n===`low`?`With elections looming, short-term wins matter more.`:`Winner-takes-all is the rational choice here.`})()}),(0,h.jsxs)(`details`,{className:n({backgroundColor:`codeBg`,padding:`3`,borderRadius:`sm`,fontSize:`xs`,color:`gray.500`}),children:[(0,h.jsx)(`summary`,{className:n({cursor:`pointer`,fontWeight:`semibold`}),children:`🔬 Technical details`}),(0,h.jsxs)(`div`,{className:n({marginTop:`2`}),children:[(0,h.jsx)(`strong`,{children:`Model:`}),` Random walk X_`,`{t+1}`,` = X_t + ε, ε ~ N(0, σ²)`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Parameters:`}),` X₀ = `,a.toFixed(2),`, σ = `,o.toFixed(2),`, δ = `,e.toFixed(2),(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Threshold:`}),` δ_min = `,u.toFixed(2),` (cooperation rational when δ `,`>`,` δ_min)`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Utility:`}),` U(Y) = Y − ½γY² with γ = `,g,(0,h.jsx)(`br`,{}),(0,h.jsx)(`strong`,{children:`Simulation:`}),` `,200,` trajectories, `,10,` periods`,(0,h.jsx)(`br`,{}),(0,h.jsx)(`button`,{onClick:()=>l(e=>e+1),className:n({marginTop:`2`,padding:`4px 8px`,backgroundColor:`blue.500`,color:`white`,border:`none`,borderRadius:`sm`,cursor:`pointer`,fontSize:`xs`}),children:`🎲 Re-run simulation`})]})]})]})},x=()=>(0,h.jsxs)(`article`,{children:[(0,h.jsx)(i,{children:`
