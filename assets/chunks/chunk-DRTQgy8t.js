import{t as e}from"./chunk-BLhQqvoO.js";var t=e(),n=`/assets/static/qml_104_4_0.DgbqdSI4.png`,r=`/assets/static/qml_104_6_0.UJQKFyHb.png`,i=`/assets/static/qml_104_9_0.CF13-MJl.png`,a=`/assets/static/qml_104_12_2.Do52PzpE.png`,o=`/assets/static/qml_104_20_2.D6RlcZsJ.png`,s=`/assets/static/qml_104_25_2.DcdVwVXP.png`,c={author:[`fretchen`],order:4,title:`QML 104 - More is different ? Working with multiple qubits`};function l(e){let c={a:`a`,code:`code`,h2:`h2`,img:`img`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(c.p,{children:[`In the `,(0,t.jsx)(c.a,{href:`./3`,children:`previous tutorial`}),` we saw how we might be able to handle more complex inputs through reuploading. However, we only discussed algorithms with single qubits until now and there is little chance that such algorithms have an impact beyond their pedagogical power.`]}),`
...
`,(0,t.jsxs)(c.p,{children:[`In the `,(0,t.jsx)(c.a,{href:`./1`,children:`first tutorials`}),` we saw how to label data that depend only on one input and had binary labels `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`y_i \\in \\{0, 1\\}`}),`. In the `,(0,t.jsx)(c.a,{href:`./3`,children:`third tutorial`}),`, we worked with a data set that had a two-dimensional input `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`\\mathbf{x}_i = (x_{1,i}, x_{2,i})`}),` and a binary label `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`y_i \\in \\{0, 1\\}`}),`. We will now build up on this work and use a data set that has:`]}),`
`,(0,t.jsxs)(c.ul,{children:[`
`,(0,t.jsxs)(c.li,{children:[`one dimensional input `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`x`}),`.`]}),`
`,(0,t.jsxs)(c.li,{children:[`Labels that go from `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`y_i \\in \\{0, 1, 2, 3\\}`}),`. Extending our previous data set.`]}),`
`]}),`
...
`,(0,t.jsxs)(c.p,{children:[`To achieve training now, we have to handle labels that go beyond binary. Quite interestingly there is a multitude of approaches on how to encode such labels, one of them was propose in the original paper `,(0,t.jsx)(c.a,{href:`https://quantum-journal.org/papers/q-2020-02-06-226/`,children:`data-reuploading approach`}),`. However, we will follow a more intuitive path in which we simply use the qubits as `,(0,t.jsx)(c.a,{href:`https://en.wikipedia.org/wiki/Binary_number`,children:`binary encoding`}),` of the labels. To represent the number `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`3`}),`, we therefore need two qubits as the result `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`|11\\rangle`}),` is then translated in `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`2^1+1^1 = 3`}),`. In summary, we will`]}),`
`,(0,t.jsxs)(c.ol,{children:[`
`,(0,t.jsxs)(c.li,{children:[`Prepare the initial state, where multiple qubits are initialized in `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`0`}),`.`]}),`
`,(0,t.jsxs)(c.li,{children:[`Apply a parametrized circuit with parameters `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`\\mathbf{w}`}),` that depend on the input `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`U(\\mathbf{w},x_i)`}),`.`]}),`
...
`,(0,t.jsxs)(c.ol,{children:[`
`,(0,t.jsxs)(c.li,{children:[`We apply a rotation gate `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`R_x`}),` on each qubit.`]}),`
`,(0,t.jsxs)(c.li,{children:[`We entangle the two qubit through a parametrized two qubit gate. A wide choice exists, but the `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`R_{zz}`}),` gate is especially nice as it creates entanglement and does not commute with the `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`R_x`}),` gates.`]}),`
`,(0,t.jsxs)(c.li,{children:[`We apply another rotation gate `,(0,t.jsx)(c.code,{className:`language-math math-inline`,children:`R_x`}),` on each qubit.`]}),`
`]}),`
