import{t as e}from"./chunk-CRAtDASX.js";import{t}from"./chunk-Cbj2n_IF.js";var n=e(),r={publishing_date:`2025-12-29`,title:`First experiences with the x402 Standard for paying AI agents`,category:`blockchain`,secondaryCategory:`ai`,description:`I implemented the x402 payment standard for AI agents to autonomously pay for image generation services without accounts or sessions.`,tokenID:176},i=[{id:`buyer`,labelLines:[`fretchen.eu/imagegen`,`(Buyer)`]},{id:`seller`,labelLines:[`imagegen-agent.fretchen.eu`,`(Seller)`]},{id:`facilitator`,labelLines:[`facilitator.fretchen.eu`,`(Facilitator)`]},{id:`blockchain`,labelLines:[`Optimism L2`,`(USDC)`]}],a=[{kind:`message`,from:`buyer`,to:`seller`,label:`1. POST /genimg (no payment)`},{kind:`message`,from:`seller`,to:`buyer`,label:`2. 402 Payment Required + PAYMENT-REQUIRED header`,style:`dashed`},{kind:`note`,from:`buyer`,to:`buyer`,label:`3. User signs EIP-3009 payment authorization`},{kind:`message`,from:`buyer`,to:`seller`,label:`4. POST /genimg + PAYMENT-SIGNATURE header`},{kind:`message`,from:`seller`,to:`facilitator`,label:`5. POST /verify`},{kind:`message`,from:`facilitator`,to:`seller`,label:`6. Payment valid ✓`,style:`dashed`},{kind:`note`,from:`seller`,to:`seller`,label:`7. Generate image + Mint NFT`},{kind:`message`,from:`seller`,to:`facilitator`,label:`8. POST /settle`},{kind:`message`,from:`facilitator`,to:`blockchain`,label:`9. transferWithAuthorization`},{kind:`message`,from:`blockchain`,to:`facilitator`,label:`10. Transaction confirmed`,style:`dashed`},{kind:`message`,from:`facilitator`,to:`seller`,label:`11. Settlement complete`,style:`dashed`},{kind:`message`,from:`seller`,to:`buyer`,label:`12. 200 OK + Image URL + NFT`,style:`dashed`}];function o(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,section:`section`,strong:`strong`,sup:`sup`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`Introduction`}),`
...
`,(0,n.jsx)(t,{participants:i,steps:a,caption:`x402 Payment Flow`}),`
...
console.log("NFT Token ID:", result.x_nft.token_id);
`})}),`
...
`]}),`
`]}),`
`]})]})}function s(e={}){let{wrapper:t}=e.components||{};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(o,{...e})}):o(e)}export{s as default,r as frontmatter,i as x402FlowParticipants,a as x402FlowSteps};