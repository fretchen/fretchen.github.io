import{A as e,N as t}from"../chunks/chunk-CM36AJFG.js";import{Cn as n,En as r,It as i,R as a,Sn as o,Tn as s,Vt as c,dn as l,i as u,n as d,r as f,t as p,wn as m,xn as h}from"../chunks/chunk-YPwviyFJ.js";import{t as g}from"../chunks/chunk-B9TWB9dF.js";import{n as _,r as ee,t as v}from"../chunks/chunk-BmLHnrvD.js";import{rn as y}from"../chunks/chunk-BloejXrp.js";import{t as b}from"../chunks/chunk-D0cgFFrk.js";import{n as x,t as S}from"../chunks/chunk-De_xcXF1.js";import{t as C}from"../chunks/chunk-jjwqej55.js";var w=t(g(),1),T=n(),E=[{name:`allowance`,type:`function`,stateMutability:`view`,inputs:[{name:`owner`,type:`address`},{name:`spender`,type:`address`}],outputs:[{name:``,type:`uint256`}]},{name:`approve`,type:`function`,stateMutability:`nonpayable`,inputs:[{name:`spender`,type:`address`},{name:`amount`,type:`uint256`}],outputs:[{name:``,type:`bool`}]}],D=[{network:`eip155:10`,label:`Optimism`},{network:`eip155:8453`,label:`Base`}],te=[...D,{network:`eip155:11155420`,label:`OP Sepolia`},{network:`eip155:84532`,label:`Base Sepolia`}],ne=[{label:`1 USDC`,value:`1`},{label:`10 USDC`,value:`10`}];function O(e){try{return x(e)}catch{return null}}var k=o({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`20px`,marginBottom:`6`,backgroundColor:`token(colors.codeBg, #f9fafb)`}),A=o({display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`8px`,marginBottom:`4`}),j=o({fontSize:`sm`,color:`#6b7280`,fontWeight:`medium`}),M=o({fontSize:`lg`,fontWeight:`semibold`}),N=o({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`}),P=o({padding:`6px 12px`,fontSize:`sm`,borderRadius:`6px`,border:`1px solid token(colors.border, #d1d5db)`,backgroundColor:`white`,cursor:`pointer`,fontWeight:`medium`,transition:`all 0.15s`,_hover:{backgroundColor:`#f3f4f6`,borderColor:`#9ca3af`},_disabled:{opacity:.5,cursor:`not-allowed`}}),F=o({backgroundColor:`#2563eb`,color:`white`,borderColor:`#2563eb`,_hover:{backgroundColor:`#1d4ed8`}}),I=o({backgroundColor:`#1e293b`,color:`white`,borderColor:`#1e293b`,_hover:{backgroundColor:`#334155`}}),L=o({fontSize:`sm`,marginTop:`3`,padding:`8px 12px`,borderRadius:`6px`}),R=o({fontSize:`sm`,color:`#6b7280`,textAlign:`center`,padding:`12px`}),z=o({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`,marginBottom:`4`});function B({facilitatorAddress:e,showTestnets:t=!1}){let{address:n,isConnected:r,chainId:i}=c(),{switchChainAsync:a}=ee(),[s,u]=(0,w.useState)(e??null),[d,f]=(0,w.useState)(null),p=t?te:D,[m,h]=(0,w.useState)(p[0].network),g=O(m),x=g?g.chainId:S(m);(0,w.useEffect)(()=>{if(e){u(e);return}let t=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=(e.extensions?.find(e=>e.name===`facilitator_fee`))?.fee?.recipient;t?u(t):f(`Facilitator address not found in /supported response`)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&f(e.message)}),()=>t.abort()},[e]);let{data:C,isLoading:B,refetch:V}=b({address:g?.address,abi:E,functionName:`allowance`,args:n&&s?[n,s]:void 0,chainId:x,query:{enabled:!!n&&!!s&&!!g}}),{writeContract:H,isPending:U,data:W}=v(),[G,K]=(0,w.useState)(void 0),{isLoading:q,isSuccess:J}=_({hash:W,chainId:G});(0,w.useEffect)(()=>{J&&V()},[J,V]);let Y=async e=>{if(!(!s||!n||!g)){if(i!==x)try{await a({chainId:x})}catch{return}K(x),H({address:g.address,abi:E,functionName:`approve`,args:[s,l(e,g.decimals)],chainId:x})}};if(d)return(0,T.jsx)(`div`,{className:k,children:(0,T.jsxs)(`p`,{className:j,children:[`Could not load facilitator address: `,d]})});if(!r)return(0,T.jsx)(`div`,{className:k,children:(0,T.jsx)(`p`,{className:R,children:`Connect your wallet to check and manage your USDC approval for the facilitator.`})});if(!g)return(0,T.jsx)(`div`,{className:k,children:(0,T.jsx)(`p`,{className:j,children:`USDC is not available on the selected network.`})});let X=C===void 0?`—`:y(C,g.decimals),Z=C!==void 0&&C>0n;return(0,T.jsxs)(`div`,{className:k,children:[(0,T.jsx)(`p`,{className:j,style:{marginBottom:`8px`},children:`Network:`}),(0,T.jsx)(`div`,{className:z,children:p.map(e=>(0,T.jsx)(`button`,{className:`${P} ${m===e.network?I:``}`,onClick:()=>h(e.network),children:e.label},e.network))}),(0,T.jsxs)(`div`,{className:A,children:[(0,T.jsxs)(`div`,{children:[(0,T.jsxs)(`p`,{className:j,children:[`Your current USDC approval on `,g.name]}),(0,T.jsx)(`p`,{className:`${M} ${o(Z?{color:`#166534`}:{color:`#6b7280`})}`,children:B?`Loading…`:`${X} USDC`})]}),s&&(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`p`,{className:j,children:`Facilitator address`}),(0,T.jsx)(`p`,{className:o({fontSize:`xs`,fontFamily:`monospace`,color:`#374151`}),children:s})]})]}),(0,T.jsxs)(`p`,{className:o({fontSize:`xs`,color:`#9ca3af`,marginBottom:`3`}),children:[`USDC on `,g.name,`: `,(0,T.jsx)(`code`,{children:g.address})]}),(0,T.jsx)(`p`,{className:j,style:{marginBottom:`8px`},children:`Approve USDC spending:`}),(0,T.jsxs)(`div`,{className:N,children:[ne.map(e=>(0,T.jsx)(`button`,{className:P,disabled:U||q||!s,onClick:()=>Y(e.value),children:e.label},e.value)),(0,T.jsx)(`button`,{className:`${P} ${F}`,disabled:U||q||!s,onClick:()=>Y(`0`),children:`Revoke`})]}),(U||q)&&(0,T.jsx)(`div`,{className:`${L} ${o({backgroundColor:`#eff6ff`,color:`#1e40af`})}`,children:U?`⏳ Confirm in your wallet…`:`⏳ Waiting for confirmation…`}),J&&(0,T.jsx)(`div`,{className:`${L} ${o({backgroundColor:`#dcfce7`,color:`#166534`})}`,children:`✓ Approval updated successfully`})]})}var V=e({default:()=>ie}),H=`
sequenceDiagram
