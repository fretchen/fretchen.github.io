import{A as e,M as t}from"../chunks/chunk-u-ScgdE-.js";import{An as n,Dn as r,It as i,Mn as a,On as o,R as s,Vt as c,i as l,jn as u,kn as d,n as f,r as p,t as m}from"../chunks/chunk-IjxM6APl.js";import{t as h}from"../chunks/chunk-DGNFK8TN.js";import{n as ee,r as te,t as g}from"../chunks/chunk-Deanrnee.js";import{Gt as _}from"../chunks/chunk-tzYWRf63.js";import{t as v}from"../chunks/chunk-B3Di7zJN.js";import{n as y,t as b}from"../chunks/chunk-lQOhhbyO.js";import{t as x}from"../chunks/chunk-6Q2KrqTl.js";import{t as S}from"../chunks/chunk-Cw2ZhjaC2.js";var C=t(h(),1),w=d(),T=[{name:`allowance`,type:`function`,stateMutability:`view`,inputs:[{name:`owner`,type:`address`},{name:`spender`,type:`address`}],outputs:[{name:``,type:`uint256`}]},{name:`approve`,type:`function`,stateMutability:`nonpayable`,inputs:[{name:`spender`,type:`address`},{name:`amount`,type:`uint256`}],outputs:[{name:``,type:`bool`}]}],E=[{network:`eip155:10`,label:`Optimism`},{network:`eip155:8453`,label:`Base`}],ne=[...E,{network:`eip155:11155420`,label:`OP Sepolia`},{network:`eip155:84532`,label:`Base Sepolia`}],D=[{label:`1 USDC`,value:`1`},{label:`10 USDC`,value:`10`}];function O(e){try{return y(e)}catch{return null}}var k=o({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`20px`,marginBottom:`6`,backgroundColor:`token(colors.codeBg, #f9fafb)`}),A=o({display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`8px`,marginBottom:`4`}),j=o({fontSize:`sm`,color:`#6b7280`,fontWeight:`medium`}),M=o({fontSize:`lg`,fontWeight:`semibold`}),N=o({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`}),P=o({padding:`6px 12px`,fontSize:`sm`,borderRadius:`6px`,border:`1px solid token(colors.border, #d1d5db)`,backgroundColor:`white`,cursor:`pointer`,fontWeight:`medium`,transition:`all 0.15s`,_hover:{backgroundColor:`#f3f4f6`,borderColor:`#9ca3af`},_disabled:{opacity:.5,cursor:`not-allowed`}}),F=o({backgroundColor:`#2563eb`,color:`white`,borderColor:`#2563eb`,_hover:{backgroundColor:`#1d4ed8`}}),I=o({backgroundColor:`#1e293b`,color:`white`,borderColor:`#1e293b`,_hover:{backgroundColor:`#334155`}}),L=o({fontSize:`sm`,marginTop:`3`,padding:`8px 12px`,borderRadius:`6px`}),R=o({fontSize:`sm`,color:`#6b7280`,textAlign:`center`,padding:`12px`}),z=o({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`,marginBottom:`4`});function B({facilitatorAddress:e,showTestnets:t=!1}){let{address:n,isConnected:r,chainId:i}=c(),{switchChainAsync:a}=te(),[s,l]=(0,C.useState)(e??null),[u,d]=(0,C.useState)(null),f=t?ne:E,[p,m]=(0,C.useState)(f[0].network),h=O(p),y=h?h.chainId:b(p);(0,C.useEffect)(()=>{if(e){l(e);return}let t=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=(e.extensions?.find(e=>e.name===`facilitator_fee`))?.fee?.recipient;t?l(t):d(`Facilitator address not found in /supported response`)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&d(e.message)}),()=>t.abort()},[e]);let{data:S,isLoading:B,refetch:V}=x({address:h?.address,abi:T,functionName:`allowance`,args:n&&s?[n,s]:void 0,chainId:y,query:{enabled:!!n&&!!s&&!!h}}),{writeContract:H,isPending:U,data:W}=g(),[G,K]=(0,C.useState)(void 0),{isLoading:q,isSuccess:J}=ee({hash:W,chainId:G});(0,C.useEffect)(()=>{J&&V()},[J,V]);let Y=async e=>{if(!(!s||!n||!h)){if(i!==y)try{await a({chainId:y})}catch{return}K(y),H({address:h.address,abi:T,functionName:`approve`,args:[s,v(e,h.decimals)],chainId:y})}};if(u)return(0,w.jsx)(`div`,{className:k,children:(0,w.jsxs)(`p`,{className:j,children:[`Could not load facilitator address: `,u]})});if(!r)return(0,w.jsx)(`div`,{className:k,children:(0,w.jsx)(`p`,{className:R,children:`Connect your wallet to check and manage your USDC approval for the facilitator.`})});if(!h)return(0,w.jsx)(`div`,{className:k,children:(0,w.jsx)(`p`,{className:j,children:`USDC is not available on the selected network.`})});let X=S===void 0?`—`:_(S,h.decimals),Z=S!==void 0&&S>0n;return(0,w.jsxs)(`div`,{className:k,children:[(0,w.jsx)(`p`,{className:j,style:{marginBottom:`8px`},children:`Network:`}),(0,w.jsx)(`div`,{className:z,children:f.map(e=>(0,w.jsx)(`button`,{className:`${P} ${p===e.network?I:``}`,onClick:()=>m(e.network),children:e.label},e.network))}),(0,w.jsxs)(`div`,{className:A,children:[(0,w.jsxs)(`div`,{children:[(0,w.jsxs)(`p`,{className:j,children:[`Your current USDC approval on `,h.name]}),(0,w.jsx)(`p`,{className:`${M} ${o(Z?{color:`#166534`}:{color:`#6b7280`})}`,children:B?`Loading…`:`${X} USDC`})]}),s&&(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`p`,{className:j,children:`Facilitator address`}),(0,w.jsx)(`p`,{className:o({fontSize:`xs`,fontFamily:`monospace`,color:`#374151`}),children:s})]})]}),(0,w.jsxs)(`p`,{className:o({fontSize:`xs`,color:`#9ca3af`,marginBottom:`3`}),children:[`USDC on `,h.name,`: `,(0,w.jsx)(`code`,{children:h.address})]}),(0,w.jsx)(`p`,{className:j,style:{marginBottom:`8px`},children:`Approve USDC spending:`}),(0,w.jsxs)(`div`,{className:N,children:[D.map(e=>(0,w.jsx)(`button`,{className:P,disabled:U||q||!s,onClick:()=>Y(e.value),children:e.label},e.value)),(0,w.jsx)(`button`,{className:`${P} ${F}`,disabled:U||q||!s,onClick:()=>Y(`0`),children:`Revoke`})]}),(U||q)&&(0,w.jsx)(`div`,{className:`${L} ${o({backgroundColor:`#eff6ff`,color:`#1e40af`})}`,children:U?`⏳ Confirm in your wallet…`:`⏳ Waiting for confirmation…`}),J&&(0,w.jsx)(`div`,{className:`${L} ${o({backgroundColor:`#dcfce7`,color:`#166534`})}`,children:`✓ Approval updated successfully`})]})}var V=e({default:()=>ie}),H=`
sequenceDiagram
...
`;function W(){let[e,t]=(0,C.useState)(null),[n,r]=(0,C.useState)(null),[i,a]=(0,C.useState)(!0);return(0,C.useEffect)(()=>{let e=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:e.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{t(e),a(!1)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&(r(e.message),a(!1))}),()=>e.abort()},[]),i?(0,w.jsx)(`span`,{className:q,children:`⏳ checking…`}):n?(0,w.jsxs)(`span`,{className:Y,children:[`✗ offline (`,n,`)`]}):e?.kinds&&e.kinds.length>0?(0,w.jsxs)(`span`,{className:J,children:[`✓ online — `,e.kinds.length,` networks`]}):(0,w.jsx)(`span`,{className:q,children:`unknown`})}var G=o({"& h2":{fontSize:`xl`,fontWeight:`semibold`,marginTop:`10`,marginBottom:`4`,paddingBottom:`2`,borderBottom:`1px solid token(colors.border)`},"& h3":{fontSize:`lg`,fontWeight:`semibold`,marginTop:`6`,marginBottom:`3`},"& p":{marginBottom:`4`,lineHeight:`1.7`},"& ul, & ol":{paddingLeft:`2em`,marginBottom:`4`},"& li":{marginBottom:`2`,lineHeight:`1.6`},"& a":{color:`token(colors.link)`,textDecoration:`underline`,_hover:{color:`token(colors.linkHover)`}},"& code":{fontSize:`sm`,backgroundColor:`token(colors.codeBg, #f3f4f6)`,padding:`1px 4px`,borderRadius:`3px`,fontFamily:`monospace`},"& pre":{backgroundColor:`#1e1e1e`,color:`#d4d4d4`,padding:`16px`,borderRadius:`8px`,overflowX:`auto`,marginBottom:`4`,fontSize:`sm`,lineHeight:`1.5`,"& code":{backgroundColor:`transparent`,padding:`0`,color:`inherit`}}}),K=o({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`token(colors.codeBg, #f9fafb)`},"& tr:last-child td":{borderBottom:`none`}}),q=o({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#f3f4f6`,color:`#6b7280`}),J=o({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#dcfce7`,color:`#166534`}),Y=o({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#fee2e2`,color:`#991b1b`}),X=o({backgroundColor:`token(colors.codeBg, #f9fafb)`,border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`16px`,marginBottom:`4`}),Z=o({listStyle:`none`,padding:`0`,marginTop:`4`,marginBottom:`6`,"& li":{padding:`6px 0`,paddingLeft:`1.5em`,position:`relative`,marginBottom:`1`,"&::before":{content:`"✓"`,position:`absolute`,left:`0`,color:`#16a34a`,fontWeight:`bold`}}}),Q=o({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,width:`28px`,height:`28px`,borderRadius:`9999px`,backgroundColor:`#2563eb`,color:`white`,fontSize:`sm`,fontWeight:`bold`,marginRight:`8px`,flexShrink:0}),$=o({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`20px`,marginBottom:`4`,backgroundColor:`token(colors.codeBg, #f9fafb)`}),re=o({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`right`},"& th:first-child, & td:first-child":{textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`token(colors.codeBg, #f9fafb)`},"& tr:last-child td":{borderBottom:`none`}});function ie(){return(0,w.jsxs)(`div`,{className:s,children:[(0,w.jsx)(`h1`,{className:i.title,children:`x402 Facilitator`}),(0,w.jsxs)(`div`,{className:G,children:[(0,w.jsxs)(`p`,{children:[`Accept crypto payments on your API or website with zero integration complexity. This is an independent`,` `,(0,w.jsx)(`a`,{href:`https://github.com/coinbase/x402`,children:`x402`}),` facilitator — it handles payment verification and on-chain settlement so you don't have to. Status: `,(0,w.jsx)(W,{})]}),(0,w.jsxs)(`ul`,{className:Z,children:[(0,w.jsxs)(`li`,{children:[(0,w.jsx)(`strong`,{children:`Only Optimism facilitator`}),` in the x402 ecosystem — if you sell on Optimism, this is your facilitator`]}),(0,w.jsxs)(`li`,{children:[(0,w.jsx)(`strong`,{children:`0.01 USDC flat fee`}),` per settlement — no percentage, no minimums`]}),(0,w.jsxs)(`li`,{children:[(0,w.jsx)(`strong`,{children:`Community-first experiment`}),` — can we make a sustainable, independent facilitator work? Join us and find out`]}),(0,w.jsxs)(`li`,{children:[(0,w.jsx)(`strong`,{children:`Open source`}),`, self-hostable, no vendor lock-in`]}),(0,w.jsxs)(`li`,{children:[(0,w.jsx)(`strong`,{children:`Other chains on request`}),` — Base support is ready, more can be added if there is interest`]})]}),(0,w.jsx)(`h2`,{children:`Quick start`}),(0,w.jsx)(`p`,{children:`Three steps to accept x402 payments on your service:`}),(0,w.jsxs)(`div`,{className:$,children:[(0,w.jsxs)(`h3`,{children:[(0,w.jsx)(`span`,{className:Q,children:`1`}),` Return a 402 response from your server`]}),(0,w.jsxs)(`p`,{children:[`When a client requests a paid resource without payment, respond with HTTP 402 and your payment requirements. Replace `,(0,w.jsx)(`code`,{children:`0xYourMerchantAddress`}),` with your wallet address and set `,(0,w.jsx)(`code`,{children:`amount`}),` to your price in USDC (6 decimals — `,(0,w.jsx)(`code`,{children:`100000`}),` = $0.10).`]}),(0,w.jsx)(`pre`,{children:(0,w.jsx)(`code`,{children:`// HTTP 402 response body:
{
  "x402Version": 2,
  "accepts": [{
    "scheme": "exact",
