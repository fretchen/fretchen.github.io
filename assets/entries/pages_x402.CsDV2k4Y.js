import{o as e,r as t}from"../chunks/chunk-C_JxhDyB.js";import{B as n,V as r,a as i,i as a,n as o,r as s,t as c,x as ee,z as l}from"../chunks/chunk-CQBj8vlt.js";import{t as u}from"../chunks/chunk-CCJ0Xh3k.js";import{t as d}from"../chunks/chunk-DuVNq-sO.js";import{t as f}from"../chunks/chunk-BLhQqvoO.js";import{r as p}from"../chunks/chunk-BDSSLxTo.js";import{n as m,t as h}from"../chunks/chunk-CLh7Hm78.js";import{ct as te}from"../chunks/chunk-Cxtpd1dG.js";import{w as g}from"../chunks/chunk-DolaQR9X.js";import{t as _}from"../chunks/chunk-BAg8Kyh-.js";import{n as v,t as y}from"../chunks/chunk-B8fKRD2L2.js";import{t as b}from"../chunks/chunk-pMgL-R_X2.js";import{n as x,s as S}from"../chunks/chunk-D80dk0st2.js";import{t as C}from"../chunks/chunk-CmqwKDxi2.js";import{t as w}from"../chunks/chunk-U5QN0rA42.js";import{n as T,t as E}from"../chunks/chunk-BZGFPQp52.js";var D=e(u(),1),O=f(),k=[{name:`allowance`,type:`function`,stateMutability:`view`,inputs:[{name:`owner`,type:`address`},{name:`spender`,type:`address`}],outputs:[{name:``,type:`uint256`}]},{name:`approve`,type:`function`,stateMutability:`nonpayable`,inputs:[{name:`spender`,type:`address`},{name:`amount`,type:`uint256`}],outputs:[{name:``,type:`bool`}]}],A=[{network:`eip155:10`,label:`Optimism`},{network:`eip155:8453`,label:`Base`}],j=[...A,{network:`eip155:11155420`,label:`OP Sepolia`},{network:`eip155:84532`,label:`Base Sepolia`}],M=[{label:`1 USDC`,value:`1`},{label:`10 USDC`,value:`10`}];function N(e){try{return T(e)}catch{return null}}var P=p({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`lg`,padding:`5`,marginBottom:`6`,backgroundColor:`codeBg`}),F=p({display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`2`,marginBottom:`4`}),I=p({fontSize:`sm`,color:`gray.500`,fontWeight:`semibold`}),ne=p({fontSize:`lg`,fontWeight:`semibold`}),re=p({display:`flex`,alignItems:`center`,gap:`2`,flexWrap:`wrap`}),L=p({fontSize:`sm`,marginTop:`3`,padding:`8px 12px`,borderRadius:`md`}),R=p({fontSize:`sm`,color:`gray.500`,textAlign:`center`,padding:`3`}),z=p({display:`flex`,alignItems:`center`,gap:`2`,flexWrap:`wrap`,marginBottom:`4`});function B({facilitatorAddress:e,showTestnets:t=!1}){let{address:n,isConnected:r,chainId:i}=ee(),{switchChainAsync:a}=_(),[o,s]=(0,D.useState)(e??null),[c,l]=(0,D.useState)(null),u=t?j:A,[d,f]=(0,D.useState)(u[0].network),h=N(d),x=h?h.chainId:E(d);(0,D.useEffect)(()=>{if(e){s(e);return}let t=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=e.facilitatorFees?.recipient;t?s(t):l(`Facilitator address not found in /supported response`)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&l(e.message)}),()=>t.abort()},[e]);let{data:S,isLoading:C,refetch:w}=b({address:h?.address,abi:k,functionName:`allowance`,args:n&&o?[n,o]:void 0,chainId:x,query:{enabled:!!n&&!!o&&!!h}}),{writeContract:T,isPending:B,data:V}=y(),[H,U]=(0,D.useState)(void 0),{isLoading:W,isSuccess:G}=v({hash:V,chainId:H});(0,D.useEffect)(()=>{G&&w()},[G,w]);let K=async e=>{if(!(!o||!n||!h)){if(i!==x)try{await a({chainId:x})}catch{return}U(x),T({address:h.address,abi:k,functionName:`approve`,args:[o,g(e,h.decimals)],chainId:x})}};if(c)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsxs)(`p`,{className:I,children:[`Could not load facilitator address: `,c]})});if(!r)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsx)(`p`,{className:R,children:`Connect your wallet to check and manage your USDC approval for the facilitator.`})});if(!h)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsx)(`p`,{className:I,children:`USDC is not available on the selected network.`})});let q=S===void 0?`—`:te(S,h.decimals),J=S!==void 0&&S>0n;return(0,O.jsxs)(`div`,{className:P,children:[(0,O.jsx)(`p`,{className:I,style:{marginBottom:`8px`},children:`Network:`}),(0,O.jsx)(`div`,{className:z,children:u.map(e=>(0,O.jsx)(`button`,{className:m({visual:`secondary`,size:`sm`,active:d===e.network}),onClick:()=>f(e.network),children:e.label},e.network))}),(0,O.jsxs)(`div`,{className:F,children:[(0,O.jsxs)(`div`,{children:[(0,O.jsxs)(`p`,{className:I,children:[`Your current USDC approval on `,h.name]}),(0,O.jsx)(`p`,{className:`${ne} ${p(J?{color:`green.800`}:{color:`gray.500`})}`,children:C?`Loading…`:`${q} USDC`})]}),o&&(0,O.jsxs)(`div`,{children:[(0,O.jsx)(`p`,{className:I,children:`Facilitator address`}),(0,O.jsx)(`p`,{className:p({fontSize:`xs`,fontFamily:`code`,color:`gray.700`}),children:o})]})]}),(0,O.jsxs)(`p`,{className:p({fontSize:`xs`,color:`gray.400`,marginBottom:`3`}),children:[`USDC on `,h.name,`: `,(0,O.jsx)(`code`,{children:h.address})]}),(0,O.jsx)(`p`,{className:I,style:{marginBottom:`8px`},children:`Approve USDC spending:`}),(0,O.jsxs)(`div`,{className:re,children:[M.map(e=>(0,O.jsx)(`button`,{className:m({visual:`secondary`,size:`sm`}),disabled:B||W||!o,onClick:()=>K(e.value),children:e.label},e.value)),(0,O.jsx)(`button`,{className:m({visual:`secondary`,size:`sm`,active:!0}),disabled:B||W||!o,onClick:()=>K(`0`),children:`Revoke`})]}),(B||W)&&(0,O.jsx)(`div`,{className:`${L} ${p({backgroundColor:`blue.50`,color:`blue.800`})}`,children:B?`⏳ Confirm in your wallet…`:`⏳ Waiting for confirmation…`}),G&&(0,O.jsx)(`div`,{className:`${L} ${p({backgroundColor:`green.100`,color:`green.800`})}`,children:`✓ Approval updated successfully`})]})}var V=t({default:()=>ae}),H=`
sequenceDiagram
...
`;function W(){let[e,t]=(0,D.useState)(null),[n,r]=(0,D.useState)(null),[i,a]=(0,D.useState)(!0);return(0,D.useEffect)(()=>{let e=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:e.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{t(e),a(!1)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&(r(e.message),a(!1))}),()=>e.abort()},[]),i?(0,O.jsx)(`span`,{className:q,children:`⏳ checking…`}):n?(0,O.jsxs)(`span`,{className:Y,children:[`✗ offline (`,n,`)`]}):e?.kinds&&e.kinds.length>0?(0,O.jsxs)(`span`,{className:J,children:[`✓ online — `,e.kinds.length,` networks`]}):(0,O.jsx)(`span`,{className:q,children:`unknown`})}var G=p({"& h2":{fontSize:`xl`,fontWeight:`semibold`,marginTop:`10`,marginBottom:`4`,paddingBottom:`2`,borderBottom:`1px solid token(colors.border)`},"& h3":{fontSize:`lg`,fontWeight:`semibold`,marginTop:`6`,marginBottom:`3`},"& p":{marginBottom:`4`,lineHeight:`relaxed`},"& ul, & ol":{paddingLeft:`8`,marginBottom:`4`},"& li":{marginBottom:`2`,lineHeight:`relaxed`},"& a":{color:`brand`,textDecoration:`underline`,_hover:{color:`brandHover`}},"& code":{fontSize:`sm`,backgroundColor:`codeBg`,padding:`2px 4px`,borderRadius:`sm`,fontFamily:`code`},"& pre":{backgroundColor:`codeSurface`,color:`codeText`,padding:`4`,borderRadius:`lg`,overflowX:`auto`,marginBottom:`4`,fontSize:`sm`,lineHeight:`normal`,"& code":{backgroundColor:`transparent`,padding:`0`,color:`inherit`}}}),K=p({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`codeBg`},"& tr:last-child td":{borderBottom:`none`}}),q=p({display:`inline-block`,padding:`2px 10px`,borderRadius:`full`,fontSize:`sm`,fontWeight:`semibold`,backgroundColor:`gray.100`,color:`gray.500`}),J=p({display:`inline-block`,padding:`2px 10px`,borderRadius:`full`,fontSize:`sm`,fontWeight:`semibold`,backgroundColor:`green.100`,color:`green.800`}),Y=p({display:`inline-block`,padding:`2px 10px`,borderRadius:`full`,fontSize:`sm`,fontWeight:`semibold`,backgroundColor:`red.100`,color:`red.800`}),X=p({backgroundColor:`codeBg`,border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`lg`,padding:`4`,marginBottom:`4`}),Z=p({listStyle:`none`,padding:`0`,marginTop:`4`,marginBottom:`6`,"& li":{padding:`6px 0`,paddingLeft:`6`,position:`relative`,marginBottom:`1`,"&::before":{content:`"✓"`,position:`absolute`,left:`0`,color:`green.600`,fontWeight:`bold`}}}),Q=p({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,width:`28px`,height:`28px`,borderRadius:`full`,backgroundColor:`blue.600`,color:`white`,fontSize:`sm`,fontWeight:`bold`,marginRight:`2`,flexShrink:0}),$=p({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`lg`,padding:`5`,marginBottom:`4`,backgroundColor:`codeBg`}),ie=p({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`right`},"& th:first-child, & td:first-child":{textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`codeBg`},"& tr:last-child td":{borderBottom:`none`}});function ae(){return(0,O.jsxs)(`div`,{className:x,children:[(0,O.jsx)(`h1`,{className:S.title,children:`x402 Facilitator`}),(0,O.jsx)(`span`,{className:h({territory:`explore`}),"aria-hidden":`true`}),(0,O.jsxs)(`div`,{className:G,children:[(0,O.jsxs)(`p`,{children:[`Accept crypto payments on your API or website with zero integration complexity. This is an independent`,` `,(0,O.jsx)(`a`,{href:`https://github.com/coinbase/x402`,children:`x402`}),` facilitator — it handles payment verification and on-chain settlement so you don't have to. Status: `,(0,O.jsx)(W,{})]}),(0,O.jsxs)(`ul`,{className:Z,children:[(0,O.jsxs)(`li`,{children:[(0,O.jsx)(`strong`,{children:`Only Optimism facilitator`}),` in the x402 ecosystem — if you sell on Optimism, this is your facilitator`]}),(0,O.jsxs)(`li`,{children:[(0,O.jsx)(`strong`,{children:`0.01 USDC flat fee`}),` per settlement — no percentage, no minimums`]}),(0,O.jsxs)(`li`,{children:[(0,O.jsx)(`strong`,{children:`Community-first experiment`}),` — can we make a sustainable, independent facilitator work? Join us and find out`]}),(0,O.jsxs)(`li`,{children:[(0,O.jsx)(`strong`,{children:`Open source`}),`, self-hostable, no vendor lock-in`]}),(0,O.jsxs)(`li`,{children:[(0,O.jsx)(`strong`,{children:`Other chains on request`}),` — Base support is ready, more can be added if there is interest`]})]}),(0,O.jsx)(`h2`,{children:`Quick start`}),(0,O.jsx)(`p`,{children:`Three steps to accept x402 payments on your service:`}),(0,O.jsxs)(`div`,{className:$,children:[(0,O.jsxs)(`h3`,{children:[(0,O.jsx)(`span`,{className:Q,children:`1`}),` Return a 402 response from your server`]}),(0,O.jsxs)(`p`,{children:[`When a client requests a paid resource without payment, respond with HTTP 402 and your payment requirements. Replace `,(0,O.jsx)(`code`,{children:`0xYourMerchantAddress`}),` with your wallet address and set `,(0,O.jsx)(`code`,{children:`amount`}),` to your price in USDC (6 decimals — `,(0,O.jsx)(`code`,{children:`100000`}),` = $0.10).`]}),(0,O.jsx)(C,{lang:`json`,children:`// HTTP 402 response body:
{
  "x402Version": 2,
  "accepts": [{
    "scheme": "exact",
