import{o as e,r as t}from"../chunks/chunk-C_JxhDyB.js";import{B as n,V as r,a as i,i as a,n as o,r as s,t as c,x as ee,z as l}from"../chunks/chunk-CJsia6X9.js";import{t as u}from"../chunks/chunk-CCJ0Xh3k.js";import{t as d}from"../chunks/chunk-DuVNq-sO.js";import{t as f}from"../chunks/chunk-BLhQqvoO.js";import{r as p}from"../chunks/chunk-BDSSLxTo.js";import{i as m,l as h,n as g,t as _}from"../chunks/chunk-flaDCudd.js";import{ct as v}from"../chunks/chunk-Cxtpd1dG.js";import{w as y}from"../chunks/chunk-DolaQR9X.js";import{t as b}from"../chunks/chunk-BwQS6z_b.js";import{n as x,t as S}from"../chunks/chunk-j4pH5PME2.js";import{t as te}from"../chunks/chunk-Nwcftrm42.js";import{t as C}from"../chunks/chunk-g5KiZ66I2.js";import{t as w}from"../chunks/chunk-U5QN0rA42.js";import{n as T,t as E}from"../chunks/chunk-BZGFPQp52.js";var D=e(u(),1),O=f(),k=[{name:`allowance`,type:`function`,stateMutability:`view`,inputs:[{name:`owner`,type:`address`},{name:`spender`,type:`address`}],outputs:[{name:``,type:`uint256`}]},{name:`approve`,type:`function`,stateMutability:`nonpayable`,inputs:[{name:`spender`,type:`address`},{name:`amount`,type:`uint256`}],outputs:[{name:``,type:`bool`}]}],A=[{network:`eip155:10`,label:`Optimism`},{network:`eip155:8453`,label:`Base`}],j=[...A,{network:`eip155:11155420`,label:`OP Sepolia`},{network:`eip155:84532`,label:`Base Sepolia`}],M=[{label:`1 USDC`,value:`1`},{label:`10 USDC`,value:`10`}];function N(e){try{return T(e)}catch{return null}}var P=p({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`lg`,padding:`5`,marginBottom:`6`,backgroundColor:`codeBg`}),F=p({display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`2`,marginBottom:`4`}),I=p({fontSize:`sm`,color:`gray.500`,fontWeight:`semibold`}),ne=p({fontSize:`lg`,fontWeight:`semibold`}),re=p({display:`flex`,alignItems:`center`,gap:`2`,flexWrap:`wrap`}),L=p({fontSize:`sm`,marginTop:`3`,padding:`8px 12px`,borderRadius:`md`}),R=p({fontSize:`sm`,color:`gray.500`,textAlign:`center`,padding:`3`}),z=p({display:`flex`,alignItems:`center`,gap:`2`,flexWrap:`wrap`,marginBottom:`4`});function B({facilitatorAddress:e,showTestnets:t=!1}){let{address:n,isConnected:r,chainId:i}=ee(),{switchChainAsync:a}=b(),[o,s]=(0,D.useState)(e??null),[c,l]=(0,D.useState)(null),u=t?j:A,[d,f]=(0,D.useState)(u[0].network),m=N(d),h=m?m.chainId:E(d);(0,D.useEffect)(()=>{if(e){s(e);return}let t=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=e.facilitatorFees?.recipient;t?s(t):l(`Facilitator address not found in /supported response`)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&l(e.message)}),()=>t.abort()},[e]);let{data:_,isLoading:C,refetch:w}=te({address:m?.address,abi:k,functionName:`allowance`,args:n&&o?[n,o]:void 0,chainId:h,query:{enabled:!!n&&!!o&&!!m}}),{writeContract:T,isPending:B,data:V}=S(),[H,U]=(0,D.useState)(void 0),{isLoading:W,isSuccess:G}=x({hash:V,chainId:H});(0,D.useEffect)(()=>{G&&w()},[G,w]);let K=async e=>{if(!(!o||!n||!m)){if(i!==h)try{await a({chainId:h})}catch{return}U(h),T({address:m.address,abi:k,functionName:`approve`,args:[o,y(e,m.decimals)],chainId:h})}};if(c)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsxs)(`p`,{className:I,children:[`Could not load facilitator address: `,c]})});if(!r)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsx)(`p`,{className:R,children:`Connect your wallet to check and manage your USDC approval for the facilitator.`})});if(!m)return(0,O.jsx)(`div`,{className:P,children:(0,O.jsx)(`p`,{className:I,children:`USDC is not available on the selected network.`})});let q=_===void 0?`—`:v(_,m.decimals),J=_!==void 0&&_>0n;return(0,O.jsxs)(`div`,{className:P,children:[(0,O.jsx)(`p`,{className:I,style:{marginBottom:`8px`},children:`Network:`}),(0,O.jsx)(`div`,{className:z,children:u.map(e=>(0,O.jsx)(`button`,{className:g({visual:`secondary`,size:`sm`,active:d===e.network}),onClick:()=>f(e.network),children:e.label},e.network))}),(0,O.jsxs)(`div`,{className:F,children:[(0,O.jsxs)(`div`,{children:[(0,O.jsxs)(`p`,{className:I,children:[`Your current USDC approval on `,m.name]}),(0,O.jsx)(`p`,{className:`${ne} ${p(J?{color:`green.800`}:{color:`gray.500`})}`,children:C?`Loading…`:`${q} USDC`})]}),o&&(0,O.jsxs)(`div`,{children:[(0,O.jsx)(`p`,{className:I,children:`Facilitator address`}),(0,O.jsx)(`p`,{className:p({fontSize:`xs`,fontFamily:`code`,color:`gray.700`}),children:o})]})]}),(0,O.jsxs)(`p`,{className:p({fontSize:`xs`,color:`gray.400`,marginBottom:`3`}),children:[`USDC on `,m.name,`: `,(0,O.jsx)(`code`,{children:m.address})]}),(0,O.jsx)(`p`,{className:I,style:{marginBottom:`8px`},children:`Approve USDC spending:`}),(0,O.jsxs)(`div`,{className:re,children:[M.map(e=>(0,O.jsx)(`button`,{className:g({visual:`secondary`,size:`sm`}),disabled:B||W||!o,onClick:()=>K(e.value),children:e.label},e.value)),(0,O.jsx)(`button`,{className:g({visual:`secondary`,size:`sm`,active:!0}),disabled:B||W||!o,onClick:()=>K(`0`),children:`Revoke`})]}),(B||W)&&(0,O.jsx)(`div`,{className:`${L} ${p({backgroundColor:`blue.50`,color:`blue.800`})}`,children:B?`⏳ Confirm in your wallet…`:`⏳ Waiting for confirmation…`}),G&&(0,O.jsx)(`div`,{className:`${L} ${p({backgroundColor:`green.100`,color:`green.800`})}`,children:`✓ Approval updated successfully`})]})}var V=t({default:()=>ae}),H=`
sequenceDiagram
