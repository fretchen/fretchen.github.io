import{A as e,M as t}from"../chunks/chunk-BYUNk3HF.js";import{An as n,Dn as r,En as i,It as a,Nn as o,On as s,R as c,Vt as l,i as u,jn as d,kn as f,n as p,r as m,t as h}from"../chunks/chunk-DXaKLeaY.js";import{n as g,r as _,t as v}from"../chunks/chunk-n8cWNhSL.js";import{Wt as y}from"../chunks/chunk-CirE-2Bt.js";import{t as b}from"../chunks/chunk-DYjuRtUA.js";import{t as x}from"../chunks/chunk-C_98OcHh.js";import{n as S,t as C}from"../chunks/chunk-DU61FXn6.js";import{t as w}from"../chunks/chunk-CAmrV7Eb.js";var T=t(o(),1),E=s(),D=[{name:`allowance`,type:`function`,stateMutability:`view`,inputs:[{name:`owner`,type:`address`},{name:`spender`,type:`address`}],outputs:[{name:``,type:`uint256`}]},{name:`approve`,type:`function`,stateMutability:`nonpayable`,inputs:[{name:`spender`,type:`address`},{name:`amount`,type:`uint256`}],outputs:[{name:``,type:`bool`}]}],O=[{network:`eip155:10`,label:`Optimism`},{network:`eip155:8453`,label:`Base`}],ee=[...O,{network:`eip155:11155420`,label:`OP Sepolia`},{network:`eip155:84532`,label:`Base Sepolia`}],k=[{label:`1 USDC`,value:`1`},{label:`10 USDC`,value:`10`}];function te(e){try{return S(e)}catch{return null}}var A=r({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`20px`,marginBottom:`6`,backgroundColor:`token(colors.codeBg, #f9fafb)`}),j=r({display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`8px`,marginBottom:`4`}),M=r({fontSize:`sm`,color:`#6b7280`,fontWeight:`medium`}),N=r({fontSize:`lg`,fontWeight:`semibold`}),P=r({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`}),F=r({padding:`6px 12px`,fontSize:`sm`,borderRadius:`6px`,border:`1px solid token(colors.border, #d1d5db)`,backgroundColor:`white`,cursor:`pointer`,fontWeight:`medium`,transition:`all 0.15s`,_hover:{backgroundColor:`#f3f4f6`,borderColor:`#9ca3af`},_disabled:{opacity:.5,cursor:`not-allowed`}}),ne=r({backgroundColor:`#2563eb`,color:`white`,borderColor:`#2563eb`,_hover:{backgroundColor:`#1d4ed8`}}),re=r({backgroundColor:`#1e293b`,color:`white`,borderColor:`#1e293b`,_hover:{backgroundColor:`#334155`}}),I=r({fontSize:`sm`,marginTop:`3`,padding:`8px 12px`,borderRadius:`6px`}),L=r({fontSize:`sm`,color:`#6b7280`,textAlign:`center`,padding:`12px`}),R=r({display:`flex`,alignItems:`center`,gap:`8px`,flexWrap:`wrap`,marginBottom:`4`});function z({facilitatorAddress:e,showTestnets:t=!1}){let{address:n,isConnected:i,chainId:a}=l(),{switchChainAsync:o}=_(),[s,c]=(0,T.useState)(e??null),[u,d]=(0,T.useState)(null),f=t?ee:O,[p,m]=(0,T.useState)(f[0].network),h=te(p),S=h?h.chainId:C(p);(0,T.useEffect)(()=>{if(e){c(e);return}let t=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=(e.extensions?.find(e=>e.name===`facilitator_fee`))?.fee?.recipient;t?c(t):d(`Facilitator address not found in /supported response`)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&d(e.message)}),()=>t.abort()},[e]);let{data:w,isLoading:z,refetch:B}=x({address:h?.address,abi:D,functionName:`allowance`,args:n&&s?[n,s]:void 0,chainId:S,query:{enabled:!!n&&!!s&&!!h}}),{writeContract:V,isPending:H,data:U}=v(),[W,G]=(0,T.useState)(void 0),{isLoading:K,isSuccess:q}=g({hash:U,chainId:W});(0,T.useEffect)(()=>{q&&B()},[q,B]);let J=async e=>{if(!(!s||!n||!h)){if(a!==S)try{await o({chainId:S})}catch{return}G(S),V({address:h.address,abi:D,functionName:`approve`,args:[s,b(e,h.decimals)],chainId:S})}};if(u)return(0,E.jsx)(`div`,{className:A,children:(0,E.jsxs)(`p`,{className:M,children:[`Could not load facilitator address: `,u]})});if(!i)return(0,E.jsx)(`div`,{className:A,children:(0,E.jsx)(`p`,{className:L,children:`Connect your wallet to check and manage your USDC approval for the facilitator.`})});if(!h)return(0,E.jsx)(`div`,{className:A,children:(0,E.jsx)(`p`,{className:M,children:`USDC is not available on the selected network.`})});let Y=w===void 0?`—`:y(w,h.decimals),X=w!==void 0&&w>0n;return(0,E.jsxs)(`div`,{className:A,children:[(0,E.jsx)(`p`,{className:M,style:{marginBottom:`8px`},children:`Network:`}),(0,E.jsx)(`div`,{className:R,children:f.map(e=>(0,E.jsx)(`button`,{className:`${F} ${p===e.network?re:``}`,onClick:()=>m(e.network),children:e.label},e.network))}),(0,E.jsxs)(`div`,{className:j,children:[(0,E.jsxs)(`div`,{children:[(0,E.jsxs)(`p`,{className:M,children:[`Your current USDC approval on `,h.name]}),(0,E.jsx)(`p`,{className:`${N} ${r(X?{color:`#166534`}:{color:`#6b7280`})}`,children:z?`Loading…`:`${Y} USDC`})]}),s&&(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`p`,{className:M,children:`Facilitator address`}),(0,E.jsx)(`p`,{className:r({fontSize:`xs`,fontFamily:`monospace`,color:`#374151`}),children:s})]})]}),(0,E.jsxs)(`p`,{className:r({fontSize:`xs`,color:`#9ca3af`,marginBottom:`3`}),children:[`USDC on `,h.name,`: `,(0,E.jsx)(`code`,{children:h.address})]}),(0,E.jsx)(`p`,{className:M,style:{marginBottom:`8px`},children:`Approve USDC spending:`}),(0,E.jsxs)(`div`,{className:P,children:[k.map(e=>(0,E.jsx)(`button`,{className:F,disabled:H||K||!s,onClick:()=>J(e.value),children:e.label},e.value)),(0,E.jsx)(`button`,{className:`${F} ${ne}`,disabled:H||K||!s,onClick:()=>J(`0`),children:`Revoke`})]}),(H||K)&&(0,E.jsx)(`div`,{className:`${I} ${r({backgroundColor:`#eff6ff`,color:`#1e40af`})}`,children:H?`⏳ Confirm in your wallet…`:`⏳ Waiting for confirmation…`}),q&&(0,E.jsx)(`div`,{className:`${I} ${r({backgroundColor:`#dcfce7`,color:`#166534`})}`,children:`✓ Approval updated successfully`})]})}var B=e({default:()=>ie}),V=`
sequenceDiagram
...
`;function U(){let[e,t]=(0,T.useState)(null),[n,r]=(0,T.useState)(null),[i,a]=(0,T.useState)(!0);return(0,T.useEffect)(()=>{let e=new AbortController;return fetch(`https://facilitator.fretchen.eu/supported`,{signal:e.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{t(e),a(!1)}).catch(e=>{e instanceof Error&&e.name!==`AbortError`&&(r(e.message),a(!1))}),()=>e.abort()},[]),i?(0,E.jsx)(`span`,{className:K,children:`⏳ checking…`}):n?(0,E.jsxs)(`span`,{className:J,children:[`✗ offline (`,n,`)`]}):e?.kinds&&e.kinds.length>0?(0,E.jsxs)(`span`,{className:q,children:[`✓ online — `,e.kinds.length,` networks`]}):(0,E.jsx)(`span`,{className:K,children:`unknown`})}var W=r({"& h2":{fontSize:`xl`,fontWeight:`semibold`,marginTop:`10`,marginBottom:`4`,paddingBottom:`2`,borderBottom:`1px solid token(colors.border)`},"& h3":{fontSize:`lg`,fontWeight:`semibold`,marginTop:`6`,marginBottom:`3`},"& p":{marginBottom:`4`,lineHeight:`1.7`},"& ul, & ol":{paddingLeft:`2em`,marginBottom:`4`},"& li":{marginBottom:`2`,lineHeight:`1.6`},"& a":{color:`token(colors.link)`,textDecoration:`underline`,_hover:{color:`token(colors.linkHover)`}},"& code":{fontSize:`sm`,backgroundColor:`token(colors.codeBg, #f3f4f6)`,padding:`1px 4px`,borderRadius:`3px`,fontFamily:`monospace`},"& pre":{backgroundColor:`#1e1e1e`,color:`#d4d4d4`,padding:`16px`,borderRadius:`8px`,overflowX:`auto`,marginBottom:`4`,fontSize:`sm`,lineHeight:`1.5`,"& code":{backgroundColor:`transparent`,padding:`0`,color:`inherit`}}}),G=r({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`token(colors.codeBg, #f9fafb)`},"& tr:last-child td":{borderBottom:`none`}}),K=r({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#f3f4f6`,color:`#6b7280`}),q=r({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#dcfce7`,color:`#166534`}),J=r({display:`inline-block`,padding:`2px 10px`,borderRadius:`9999px`,fontSize:`sm`,fontWeight:`medium`,backgroundColor:`#fee2e2`,color:`#991b1b`}),Y=r({backgroundColor:`token(colors.codeBg, #f9fafb)`,border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`16px`,marginBottom:`4`}),X=r({listStyle:`none`,padding:`0`,marginTop:`4`,marginBottom:`6`,"& li":{padding:`6px 0`,paddingLeft:`1.5em`,position:`relative`,marginBottom:`1`,"&::before":{content:`"✓"`,position:`absolute`,left:`0`,color:`#16a34a`,fontWeight:`bold`}}}),Z=r({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,width:`28px`,height:`28px`,borderRadius:`9999px`,backgroundColor:`#2563eb`,color:`white`,fontSize:`sm`,fontWeight:`bold`,marginRight:`8px`,flexShrink:0}),Q=r({border:`1px solid token(colors.border, #e5e7eb)`,borderRadius:`8px`,padding:`20px`,marginBottom:`4`,backgroundColor:`token(colors.codeBg, #f9fafb)`}),$=r({width:`100%`,borderCollapse:`collapse`,marginBottom:`6`,fontSize:`sm`,"& th, & td":{padding:`8px 12px`,borderBottom:`1px solid token(colors.border, #e5e7eb)`,textAlign:`right`},"& th:first-child, & td:first-child":{textAlign:`left`},"& th":{fontWeight:`semibold`,backgroundColor:`token(colors.codeBg, #f9fafb)`},"& tr:last-child td":{borderBottom:`none`}});function ie(){return(0,E.jsxs)(`div`,{className:c,children:[(0,E.jsx)(`h1`,{className:a.title,children:`x402 Facilitator`}),(0,E.jsxs)(`div`,{className:W,children:[(0,E.jsxs)(`p`,{children:[`Accept crypto payments on your API or website with zero integration complexity. This is an independent`,` `,(0,E.jsx)(`a`,{href:`https://github.com/coinbase/x402`,children:`x402`}),` facilitator — it handles payment verification and on-chain settlement so you don't have to. Status: `,(0,E.jsx)(U,{})]}),(0,E.jsxs)(`ul`,{className:X,children:[(0,E.jsxs)(`li`,{children:[(0,E.jsx)(`strong`,{children:`Only Optimism facilitator`}),` in the x402 ecosystem — if you sell on Optimism, this is your facilitator`]}),(0,E.jsxs)(`li`,{children:[(0,E.jsx)(`strong`,{children:`0.01 USDC flat fee`}),` per settlement — no percentage, no minimums`]}),(0,E.jsxs)(`li`,{children:[(0,E.jsx)(`strong`,{children:`Community-first experiment`}),` — can we make a sustainable, independent facilitator work? Join us and find out`]}),(0,E.jsxs)(`li`,{children:[(0,E.jsx)(`strong`,{children:`Open source`}),`, self-hostable, no vendor lock-in`]}),(0,E.jsxs)(`li`,{children:[(0,E.jsx)(`strong`,{children:`Other chains on request`}),` — Base support is ready, more can be added if there is interest`]})]}),(0,E.jsx)(`h2`,{children:`Quick start`}),(0,E.jsx)(`p`,{children:`Three steps to accept x402 payments on your service:`}),(0,E.jsxs)(`div`,{className:Q,children:[(0,E.jsxs)(`h3`,{children:[(0,E.jsx)(`span`,{className:Z,children:`1`}),` Return a 402 response from your server`]}),(0,E.jsxs)(`p`,{children:[`When a client requests a paid resource without payment, respond with HTTP 402 and your payment requirements. Replace `,(0,E.jsx)(`code`,{children:`0xYourMerchantAddress`}),` with your wallet address and set `,(0,E.jsx)(`code`,{children:`amount`}),` to your price in USDC (6 decimals — `,(0,E.jsx)(`code`,{children:`100000`}),` = $0.10).`]}),(0,E.jsx)(`pre`,{children:(0,E.jsx)(`code`,{children:`// HTTP 402 response body:
{
  "x402Version": 2,
  "accepts": [{
    "scheme": "exact",
