    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev Marks a token as updated with an image, emits an event and pays the updater.
    ...
    function requestImageUpdate(uint256 tokenId, string memory imageUrl) public {
        ...
        if (!_whitelistedAgentWallets[msg.sender]) revert NotAuthorizedAgent();
