 ...
 * `observability/alerts/*.yaml`'s "The logger.error convention" and `test/alert_coverage.test.ts`),
 * which makes one shared, importable instance the natural place to enforce that structurally
 * later, too.
 */
