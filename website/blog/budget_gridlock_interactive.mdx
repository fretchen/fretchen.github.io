...
{/* SPIKE (Stufe 2.0, website/MDX_MIGRATION.md) Q3: clientOnly() is deprecated in the
    installed vike-react — used here anyway, deliberately, because it's the cheapest way to
    test whether a widget-in-a-primed-post-module still renders correctly client-side-only.
    Revert to a plain import if the spike is discarded. */}
import { clientOnly } from "vike-react/clientOnly";
export const BudgetNegotiationWidget = clientOnly(() => import("../components/blog/BudgetNegotiationWidget"));
