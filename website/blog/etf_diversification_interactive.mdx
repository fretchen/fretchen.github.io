...
{/* Chart.js pulls a ~25KB gzip shared chunk — kept out of this post's own primed module so
    it doesn't sit in the pre-hydration blocking path (see website/MDX_MIGRATION.md §2.1). */}
export const DiversificationRandomWalk = clientOnly(() => import("../components/blog/DiversificationRandomWalk"));
