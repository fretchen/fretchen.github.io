...
{/* Both pull in @openzeppelin/merkle-tree, a ~42KB gzip shared chunk — the heaviest
    dependency found in any post's widgets — kept out of this post's own primed module so it
    doesn't sit in the pre-hydration blocking path (website/MDX_MIGRATION.md §2.1). */}
export const BatchCreator = clientOnly(() => import("../components/blog/BatchCreator"));
export const ProofDemo = clientOnly(() => import("../components/blog/ProofDemo"));
