...
export const meta = {
  ...
  tokenID: 35,
  description: "I explore solutions to the Tragedy of the Commons through interactive island simulations. I learn how different governance models affect resource sustainability and community outcomes.",
};
