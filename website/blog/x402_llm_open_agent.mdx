...
I was able to tackle of of them with new technology in form of x402 [batch-settlement](https://x402.org/x402-batch-settlement/). I already covered [x402 itself](/blog/22/) when I put it behind my image generator.
...
A very low bar: speak this body shape, accept USDC on Optimism or Base via batch-settlement, and you are an `llm/v1` agent. Anything that can pay one can pay all of them. [x402scan](https://www.x402scan.com) is a crawler that indexes x402-payable endpoints. It found my agents, read their specs, and listed them — the [AI assistant](https://www.x402scan.com/server/f2788b7c-7933-42c2-9e69-ed57cf91e58a) and the [image generator](https://www.x402scan.com/server/1246cf89-3c1d-4a2d-9cb7-d96a4b40e9a6).
