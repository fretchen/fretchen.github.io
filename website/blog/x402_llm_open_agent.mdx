...
To be clear, this is less exposure rather than none. The deposit and the final payout are still on-chain, so anyone can see that your wallet opened a channel with my agent and roughly what it paid in the end. What is gone is everything in between: how many messages, how long they were, and when you sent them.
