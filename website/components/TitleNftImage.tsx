...
/**
 * Small NFT image that appears before the title
 */
export const TitleNftImage: React.FC<TitleNftImageProps> = ({ tokenId, fallbackImageUrl, nftName }) => {
  ...
  return (
    <>
      {isLoading ? (
        <div 
          className={entryList.titleNftImage} 
