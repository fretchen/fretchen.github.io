...
export const BRETAGNE: CoastRegion = {
  name: "bretagne",
  worldSize: 100,
  points: [
    [76.634, 73.821],
  ...
  meta: {
    sourceLengthKm: 1971.7732460448683,
    simplificationToleranceDeg: 0.0025,
    minCellSizeWorld: 1.5625,
    minCellSizeRealKm: 3.9936135910971187,
    boundingBox: {
      lonMin: -4.797583,
      lonMax: -1.3575,
      latMin: 47.203333,
...
export const NORMANDIE: CoastRegion = {
  name: "normandie",
  worldSize: 100,
  points: [
    [0, 33.811],
  ...
  meta: {
    sourceLengthKm: 265.70253627275014,
    simplificationToleranceDeg: 0.0025,
    minCellSizeWorld: 1.5625,
    minCellSizeRealKm: 3.9936135910971187,
    boundingBox: {
