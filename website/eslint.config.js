...
export default tseslint.config(
  {
    ignores: [
      ...
      "*.cjs",
      "*.mjs",
      // Generated by utils/coastsToTs.ts from notebooks/output/box_dimension_coasts.json —
      // not hand-formatted, same reasoning as excluding styled-system/ above.
      "components/blog/box-dimension/coasts.ts",
    ],
  },
