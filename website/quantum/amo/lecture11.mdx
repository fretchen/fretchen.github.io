...
import pic1 from "./lecture11_pic1.png";
import pic2 from "./lecture11_pic2.png";
import pic3 from "./lecture11_pic3.png";
import pic4 from "./lecture11_pic4.png";
...
<MyFigure id="fig-laser" href={pic1} caption="The Laser set-up" />
...
<MyFigure id="fig-susc" href={pic2} caption="Susceptibility of the two level system" />
...
<MyFigure id="fig-4level" href={pic3} caption="The 4 level system" />
...
<MyFigure id="fig-freq-laser" href={pic4} caption="Frequency distribution of the steady-state laser" />
