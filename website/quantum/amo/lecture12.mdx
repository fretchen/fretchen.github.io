...
import pic1 from "./lecture12_pic1.png";
import pic2 from "./lecture12_pic2.png";
import pic3 from "./lecture12_pic3.png";
import pic4 from "./lecture12_pic4.png";
import pic5 from "./lecture12_pic5.png";
import pic6 from "./lecture12_pic6.svg";
...
<MyFigure id="fig-downcon" href={pic1} caption="The process of spontaneous parametric down-conversion (SPDC) and photon detection setup" />
...
<MyFigure id="fig-polar-anal" href={pic2} caption="Polarization analysis of correlated photons" />
...
<MyFigure id="fig-two-qubit" href={pic3} caption="Realizing the two-photon experiment within a quantum circuit" />
...
<MyFigure id="fig-corr" href={pic4} caption="Correlation coefficient" />
...
<MyFigure id="fig-bell" href={pic5} caption="A Bell experiment" />
...
<MyFigure id="fig-measure" href={pic5} caption="Correlation measurements" />
