...
import pic1 from "./lecture17_pic1.png"
import pic2 from "./lecture17_pic2.png"
import pic3 from "./lecture17_pic3.png"
import pic4 from "./lecture17_pic4.png"
import pic5 from "./lecture17_pic5.png"
...
<MyFigure id="fig-potential" href={pic1} caption="The molecular potential curves obtained from the Born-Oppenheimer Approximation" />
...
<MyFigure id="fig-internuclear" href={pic2} caption="Internuclear potential with vibrational levels" />
...
<MyFigure id="fig-franck-condon" href={pic3} caption="The Franck-Condon principle for a simple toy model" />
...
<MyFigure id="fig-ni2008" href={pic4} caption="Production of groundstate molecules of K + Rb" />
...
<MyFigure id="fig-dipole" href={pic5} caption="Search for the permanent electric dipole moment" />
