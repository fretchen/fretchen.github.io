...
import pic1 from "./lecture19_pic1.png";
import pic2 from "./lecture19_pic2.png";
import pic3 from "./lecture19_pic3.png";
import pic4 from "./lecture19_pic4.png";
import pic5 from "./lecture19_pic5.png";
import pic6 from "./lecture19_pic6.png";
...
<MyFigure id="fig-rydberg" href={pic1} caption="Rydberg atoms interacting with photons in a cavity" />
...
<MyFigure
  id="fig-rydberg"
  href={pic2}
  caption="The ground and excited state $\left|g\right\rangle$ and $\left|e\right\rangle$ of the atom on an energy scale. Here, the energy of the ground state is $E_g = 0$. The energy difference between the two states is $\hbar\omega_0$. A photon of the surrounding light field has an energy $\hbar\omega_L$."
/>
...
<MyFigure
  id="fig-bare-diagram"
  href={pic3}
  caption="An energy diagram of the bare states. Note that the interaction between atom and light field has not yet been introduced!"
/>
...
<MyFigure id="fig-dressed-diagram" href={pic4} caption="An energy diagram showing the bare and the dressed states." />

The corresponding eigenvectors are then a mixture of atom and light as
visualized in the figure below.

<MyFigure
  id="fig-dressed-energies"
  href={pic5}
  caption="Energies of the bare and dressed states as a function of the detuning."
/>
...
<MyFigure
  id="fig-coherence"
  href={pic6}
  caption="Observation of quantum Rabi oscillations in [Brune 1996](http://dx.doi.org/10.1038/22275)."
/>
