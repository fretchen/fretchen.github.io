...
<MyFigure id="fig-bare-diagram" href={pic3} caption="An energy diagram of the bare states. Note that the interaction between atom and light field has not yet been introduced!" />
</figure>
...
<MyFigure id="fig-dressed-energies" href={pic5} caption="Energies of the bare and dressed states as a function of the detuning." />
</figure>
...
<MyFigure id="fig-coherence" href={pic6} caption="Observation of quantum Rabi oscillations in [Brune 1996](http://dx.doi.org/10.1038/22275)." />
</figure>
