...
---
import pic1 from "./lecture3_pic1.png";
import pic2 from "./lecture3_pic2.png";
import pic3 from "./lecture3_pic3.png";
import pic4 from "./lecture3_pic4.png";
...
<figure id="fig-two-level-examples">
<img src={pic1} width="90%" alt="Examples for two-state systems: a) Benzene, b) Ammonia, c) Molecular ion" />
<figcaption>Examples for two-state systems. a) Benzene: In the ground state, the
...
localized near proton 1 or 2.</figcaption>
</figure>
...
<figure id="fig-energy-levels">
<img src={pic2} width="90%" alt="Energy levels and eigenstates diagram for the two-level system" />
<figcaption>Energy levels and eigenstates of the two-level system showing the coupling $\Omega$ and detuning $\Delta$.</figcaption>
</figure>
...
<figure id="fig-bloch-sphere">
<img src={pic3} width="90%" alt="The Bloch sphere representation of quantum states" />
<figcaption>The Bloch sphere: A geometrical representation of quantum states in a two-level system, where any quantum state can be represented as a point on the unit sphere.</figcaption>
</figure>
...
<figure id="fig-rabi-oscillations">
<img src={pic4} width="90%" alt="Rabi oscillations and population dynamics" />
<figcaption>Rabi oscillations: The time evolution of the population in state 1 according to Rabi's formula, showing oscillatory behavior at the Rabi frequency $\sqrt{|\Omega|^2+\Delta^2}$.</figcaption>
</figure>
