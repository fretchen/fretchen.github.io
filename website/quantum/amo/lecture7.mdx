...
import pic1 from "./lecture7_pic1.png";
import pic2 from "./lecture7_pic2.png";
...
<MyFigure id="fig-zeeman-effect-hydrogen" href={pic1} caption="The Zeeman effect in the hydrogen atom" />
...
<MyFigure id="fig-paul-trap-schematic" href={pic2} caption="Paul trap schematic and linear ion trap with calcium ions" />
