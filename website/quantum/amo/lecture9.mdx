...
<MyFigure id="fig-helium-level-scheme" href={pic2} caption="Level scheme of singlet and triplet states of the helium atom" />
...
<MyFigure id="fig-helium-transitions" href={pic4} caption="Possible transitions within the singlet and triplet system of helium" />
