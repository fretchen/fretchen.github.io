...
import pic1 from "./bell_inequalities_files/bell_inequalities_7_1.png";
import pic2 from "./bell_inequalities_files/bell_inequalities_9_0.png";
import pic3 from "./bell_inequalities_files/bell_inequalities_15_1.png";
...
<MyFigure
  id="fig-classical-profit"
  href={pic1}
  caption="Accumulated profit over 10,000 games using classical strategy"
/>
...
<MyFigure id="fig-quantum-circuit" href={pic2} caption="Quantum circuit to create an entangled Bell state" />
...
<MyFigure
  id="fig-quantum-advantage"
  href={pic3}
  caption="Comparison of accumulated profit: classical strategy vs quantum strategy showing quantum advantage"
/>
