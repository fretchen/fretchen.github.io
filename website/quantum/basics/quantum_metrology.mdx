...
<MyFigure 
  id="fig-atomic-orbits"
  href={pic1}
  caption="Atomic structure showing electron orbits around the nucleus"
/>
...
<MyFigure 
  id="fig-magnetic-field-effect"
  href={pic2}
  caption="Effect of magnetic field on atomic electron orbits"
/>
