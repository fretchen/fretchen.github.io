...
export const GLOB_REGISTRY = {
  blog: {
    eager: import.meta.glob<{ default: React.ComponentType }>(["../blog/*.{tsx,md,mdx}", "!../blog/*.plan.md"], { eager: true }),
    lazy: import.meta.glob<{ default: React.ComponentType }>(["../blog/*.{tsx,md,mdx}", "!../blog/*.plan.md"], { eager: false }),
  },
  "quantum/amo": {
